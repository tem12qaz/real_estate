var AdminModelCustomActions = function(actionErrorMessage, actionConfirmations) {
...
var customModelActions = new AdminModelCustomActions(JSON.parse($('#message-data').text()), JSON.parse($('#actions-confirmation-data').text()));
